...
class  ExtendableTextWidget extends StatefulWidget {
  final String text;
  const ExtendableTextWidget({Key? key,required this.text}) : super(key:key);

  @override
  _ExtendableTextWidget createState() => _ExtendableTextWidget();
}

class _ExtendableTextWidget extends State<ExtendableTextWidget> {
